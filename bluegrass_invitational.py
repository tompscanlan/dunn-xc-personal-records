...
# drop unneeded cols
bluegrass = bluegrass.drop(columns=['index', 'bibnumber', 'points', 'lastname', 'firstname', 'school', 'time'])
...
all_runners = best_times.merge(bluegrass, on='name', how='outer', indicator=True, suffixes=('_best', '_tully'))
